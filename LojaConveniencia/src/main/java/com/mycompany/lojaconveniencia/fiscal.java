...
public class fiscal {
    ...
    public fiscal(int idFiscal, int numeroNotaFiscal, String valorTotal, String tipoNota, double imposto, double juros, double multa, String dataEmissao, String dataVencimento) {
    ...
    public void menuFiscal() {
        ...
        do {
            ...
            if (ler.hasNextInt()) {
                ...
                System.out.println("Opção inválida. Favor informar outra opção.");
                ler.next(); //favor não apagar garante que o menu não entre em loop infinito caso uma informação errada seja passada no scanner
            }
        } while (opcao != 0);
    }
