...
public class Banco {
    ...
    public void cadastrarBanco(int id, String cnpj, String nome, String cep, String estado, String cidade, String numero) {
        this.idBanco = id;
        this.cnpjBanco = cnpj;
        ...
        do {
            ...
            if (inserir.hasNextInt()) {
                ...
                switch (escolhaMenuBanco) {
                    case 1:
                        System.out.println("Teste, informações sendo passadas: 1, 12.345.678/5555-01, Losango, 12345-987, Parana, Cascavel, 3333-2222");
                        bancoTeste.cadastrarBanco(1, "12.345.678/5555-01", "Losango", "12345-987", "Parana", "Cascavel", "3333-2222");
                        break;
                    ...
                    case 2:
                        ...
                        if (escolhaMenuBanco == 1) {
                            System.out.println("Teste, a informação sendo passada no id é 0, para testar a mensagem de falha");
